...
public class VarEx3 {
	...
	public static void main(String[] args) {
		 ...
		 * 하지만 메모리 관리, 유효성 관리 등이 어렵기 때문에 하지 않는다
		 * 
		 */
		List<Object> objlist;
		...
		// 데이터의 유효성검사
		// Integer type만 add 할수있는 intList에
		// Float type의 값을 추가하려고 하니
		// 오류가 발생한다
		// intList.add(30.0f);
		 ...
		 * 항상 걱정하면서 코딩을 해야할 것이다
		 * 
		 * 사전에 제네릭을 선언함으로서
		 * 개발자는 데이터에 대한 유효성문제를 걱정하지 않아도 된다
		 * 
