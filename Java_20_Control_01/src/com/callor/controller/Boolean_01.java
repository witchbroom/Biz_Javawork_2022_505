...
public class Boolean_01 {
	...
	public static void main(String[] args) {
		...
		boolean bGT = intNum1 > intNum2; // greate than
		boolean bLT = intNum1 < intNum2; // less than
		
		/*
		 * 논리적 오류(문제)가 있는 코드
		 * 아래 코드에서 intNum1과 intNum2의 같음과 크기를 비교하여 그 결과를 보여주고 있다
		 * 하지만 처음 같은지 비교를 하고 그 결과가 false이면
		 * 서로 다른지 비교를 한다 당연히 같지 않으면 bNotEq가 true가 될 것이고
