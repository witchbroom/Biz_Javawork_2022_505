...
public class Var_04 {
	...
	public static void main(String[] args) {
		 ...
		 * 그렇기 때문에 코드는 오류메세지를 보여준다
		 * 하지만 개발자가 실수값중에서 소수점 이하는 필요가 없고
		 * 정수부분만 필요하니 소수점 이하 값을 제거하고
		 * 정수 부분만 intRnd변수에 담아달라고
		 * 강제로 명령을 내린다
		 * type 키워드를 () 묶어 변수 앞에 표시한다
		 * 
		 * 실수 = 정수와 같은 명령을 수행하면
		 * 실수형 변수는 정수값을 저장하기에 충분히 큰 기억장치이므로 문제가 발생하지 않는다
		 * double num = 30; 과 같은 코드가 실행되면
		 * num 변수에는 30.0000000과 같이 저장이 된다.
		 */
