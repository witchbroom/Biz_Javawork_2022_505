...
public class ExecV0 {
	...
	/*
	 * 진입점 메서드 프로젝트를 Run 했을때 제일먼저 실행되는 메서드 프로젝트를 Run 했을때 제일먼저 실행되는 위치 시작점 이라고도 함
	 */
	public static void main(String[] args) {

		/*
		 * 정수형변수 num를 선언하고 clear 하였다 정수형변수 num를 생성하였다
		 */
		int num = 0;

		/*
		 * 1. 클래스를 사용하여 객체를 선언하고 생성자를 호출하여 초기화하였다 2. exec00 인스턴스를 생성하였다
		 */
