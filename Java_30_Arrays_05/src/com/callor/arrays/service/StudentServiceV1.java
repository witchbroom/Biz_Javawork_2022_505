...
public class StudentServiceV1 {
	...
	// 기본 생성자
	// 클래스를 생성하면 자동으로 선언되는 생성자 메서드
	public StudentServiceV1() {
		// strStudents = new String[10];
		// scan = new Scanner(System.in);
		/*
		 * strStudents, scan 2개의 변수는 초기화가 되어야 하는데
		 * 생성자에서 초기화시키는 코드를 작성한다
		 * 하지만 현재 ServiceV1 클래스에는 2개의 생성자가 있다
		 * 그래서 기본생성자에서는 임의생성자에게 정수 10을 전달하면서
		 * strStudents와 scan 2개의 변수를 초기화하도록
		 * toss해버린다
		 */
		this(10);
	}
