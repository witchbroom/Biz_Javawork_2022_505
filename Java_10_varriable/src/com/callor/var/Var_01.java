...
public class Var_01 {
 ...
 public static void main(String[] args) {
	  ...
	  * 
	  * 정수형 변수 num1을 선언하고 정수 255값으로 초기화 하라
	  * 정수형 변수 num2를 선언하고 정수 88값으로 초기화 하라
	  */
	 int num1 = 255;
	 int num2 = 88; 
	...
	// 숫자일 경우는 0으로 초기화(initialize)를 해 둔다
	int num5 = 0;
	 ...
	 * 변수명만 보고 어떤 데이터가 담겨있는지 유추할수 있도록 하자
	 */
