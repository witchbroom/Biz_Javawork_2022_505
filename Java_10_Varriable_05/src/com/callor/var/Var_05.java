...
public class Var_05 {
	...
	public static void main(String[] args) {
		 ...
		 * = "" : 선언된 문자열형 변수를 clear(숫자형에서 0을 대입하는것과 유사)
		 */
		String strNation = "";
		 ...
		 * 2. (내부적으로 정해진)어떤 곳에 대한민국 문자열을 기억장치 1개당 한글자씩 나눠서 저장한다
		 ...
		 * 2. 이 값은 그냥 데이터가 아니고 다른 기억장소의 주소라는 표식이 있다
		 * 3. 기억장소에 저장된 주소를 기준으로 실제 문자열 "대한민국"이 저장된 곳을 찾는다
